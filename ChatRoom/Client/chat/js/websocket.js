window.addEventListener('load', () => {
    ...
    async function fakeChat() {
        const months = [
            "Всем привет. Меня зовут Bekmurat. Я из Казахстана. Поток FPW-31",
            "Я Антон,с г.Санкт-Петербург.Мне 24 года. Поток FPW-12",
            ...
            "Из Екатеринбурга (Урал). 10 лет работал в строительстве, вот решил полностью сменить направление работы)",

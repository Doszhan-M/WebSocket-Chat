...
#### Все файлы касающиеся frontend части, находятся в папке Client. Почти все функции выполняются через javascript, django лишь предоставляет и сохраняет данные в базу данных.
